...
#include "standardsupplyprofileview.h"


StandardSupplyProfileView::StandardSupplyProfileView( QWidget *parent ) : QTableView( parent )
{
 ...
 StandardSupplyProfileView::~StandardSupplyProfileView()
{
